---
title: 'Disegna il tuo FUTURO: al via il service sui disturbi alimentari'
titleEn: 'Disegna il tuo FUTURO: service tackles eating disorders'
scope:
  - Distretto
  - Service Distrettuale
  - Service Nazionale
excerpt: 'Il Distretto 2050 lancia un service, ora adottato a livello nazionale, per sensibilizzare sui disturbi del comportamento alimentare.'
excerptEn: 'District 2050 launches a service on eating disorder awareness, now adopted nationwide.'
date: 2026-08-05T09:00:00.000Z
image: /uploads/news/2026-2027/Disegna-il-tuo-futuro-(logo).jpeg
imageFocalX: 78
imageFocalY: 82
imageLabel: Foto news
imageLabelEn: News photo
bodyEn: |
  Promoted by District 2050 and adopted nationwide, Disegna il tuo FUTURO ("Draw Your FUTURE") is a service designed to raise public awareness of eating disorders (EDs). The project takes shape through dialogue with doctors and experts, first-hand accounts of recovery journeys, digital campaigns, and an art workshop culminating in a public exhibition of the participants' work.

  Its goals are:

  * Inform: promote rigorous, clear and accessible knowledge about EDs.
  * Raise awareness: bring to light the deep emotional vulnerability caused by body shaming.
